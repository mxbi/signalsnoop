...
# ╔═╡ b8e000f7-e159-4a1e-b33e-42d1da662228
data
...
riq = resample(data, 64_000_000, PIXEL_CLOCK*SAMPLE_FACTOR)

# ╔═╡ a6a611f2-143e-4e50-adaf-60ba337899ce
plot(abs.(riq[1:10000]))
...
begin
	dat = abs.(rowify(riq[1:LINE_SIZE*N_LINES*SAMPLE_FACTOR*N_FRAMES], LINE_SIZE*SAMPLE_FACTOR))'
	dat ./= maximum(dat)
	Gray.(dat)
end
...
julia_version = "1.8.2"
manifest_format = "2.0"
project_hash = "9b37016eb462b7bd3b907d2803ec9b368b65f88c"
